    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-6">About The Compiler</h1>

          <div className="prose dark:prose-invert max-w-none">
            <p>
              The Compiler is a personal news aggregator that curates discussions from Hacker News using AI. Instead of
            ...
            <p>Every day, The Compiler fetches the top posts from Hacker News and uses AI to:</p>
            ...
            <p>The Compiler is built with:</p>
